class NavHandler {
    ...
    */
    generateContent(){
        ...
        let centerPane            = document.getElementById('prayoshaAddin');
    ...
    enableDisplayToggle(){
        ...
        displayToggle.addEventListener('click', () => {
            if(this.focus){
                ...
                global.geotab.addin.prayoshaAddin.blur();
            } else {
                displayToggle.innerHTML = 'Blur add-in';
                global.geotab.addin.prayoshaAddin.focus(global.api, global.state);
            }
    ...
    listenToHash(){
        ...
        setInterval(()=>{
            if(window.location.hash !== this.storedHash){
                this.storedHash = window.location.hash;
                if(this.storedHash !== '#' + 'prayoshaAddin'){
                    geotab.addin.prayoshaAddin.blur();
                } else {
                    geotab.addin.prayoshaAddin.focus(global.api, global.state);
                }
            }
        }, 100);
    }
